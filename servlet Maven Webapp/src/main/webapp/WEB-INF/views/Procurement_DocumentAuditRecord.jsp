...
<body class="page-header-fixed">
				...
				<ul class="nav pull-right">
					...
					<!--<li class="dropdown user">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="login1.action"><i class="icon-user"></i> 登录</a></li>

							<li><a href="dcregiser.action"><i class="icon-key"></i> 注册</a></li>

						</ul>

					</li> -->
						<!-- END USER LOGIN DROPDOWN 未登录 -->
			  ...
			  <div class="row-fluid">
				...
				<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-coffee"></i>单据审批记录</div>
								...
								<table class="table  table-hover">
									...
									<c:forEach items="${pos}" var="item2" >
										...
										<tr>
										    ...
										    <!--<span class="label label-success">审核<a href="Procurement_PurchasingAuditOperation?id=${item2.paid}"></a></span>-->
										...
										<td colspan="12">
											<label>第${page2.currentPage2}/${page2.totalPage2}页 共${page2.totalRows2}条
											   <a href="init2.do?currentPage2=0">首页</a> 
											   <a href="init2.do?currentPage2=${page2.currentPage2-1}" onclick="return checkFirst2()">上一页</a> 
											   <a href="init2.do?currentPage2=${page2.currentPage2+1}" onclick="return checkNext2()">下一页</a> 
											   <a href="init2.do?currentPage2=${page2.totalPage2}">尾页</a> 跳转到:
											   <input type="text" style="width:4%;height:3%" class="portlet box White" id="turnPage2" />页 
    ...
    var shref="init2.do?currentPage2="+turnPage2;
