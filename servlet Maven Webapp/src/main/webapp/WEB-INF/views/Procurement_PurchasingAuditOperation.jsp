				  ...
				  <div class="span12">
					...
					<h3 class="page-title">
					  ...
					  <ul class="breadcrumb">
						  ...
						  <li><a href="getStateisdshlists">采购审核</a>
						      <i class="icon-angle-right"></i>
						  </li>		
						  <li>
							  <a href="#">比价采购——审核操作</a>
...
<form action="#提交需求创建" method="post" name="addForm"  onsubmit="return CheckPost();">
				<div class="row-fluid">
					...
					<input type="button" id="approvedbtn" class="btn blue button-next" value="审核通过">
							
					<input type="button" id="rejectbtn"  class="btn blue button-next" value="驳回">
						
				    <a href="getStateisdshlists" class="btn green button-submit">返回 <i class="m-icon-swapright m-icon-white"></i></a>
					</div>	
